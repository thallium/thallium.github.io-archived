---
published: true
title: CUGBACM18级训练#6 题解/Tutorial
category: 训练题解
tags: CUGBACM
layout: post
output: pdf_document
...
# J - Spilt the String Gym - 101498J 

Enumerate all the possible disstance between two spilting point and check if all the spilting points are space. If you could find such a distance the answer is "YES" and vise versa.